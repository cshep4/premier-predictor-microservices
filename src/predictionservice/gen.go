...
//go:generate mockgen -destination=internal/mocks/prediction/service/mocks/mock_service.gen.go -package=prediction_mocks github.com/cshep4/premier-predictor-microservices/src/predictionservice/internal/handler Service
