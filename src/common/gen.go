...
//go:generate mockgen -destination=internal/mocks/auth/authorizer.gen.go -package=auth_mocks github.com/cshep4/premier-predictor-microservices/src/common/auth/http Authorizer
